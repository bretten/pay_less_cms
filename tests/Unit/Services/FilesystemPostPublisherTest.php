...
class FilesystemPostPublisherTest extends TestCase
{
    ...
    /**
     * Tests that Posts can be published to the Filesystem with a custom site view and with paginated index files
     *
     * @return void
     * @throws \League\Flysystem\FileNotFoundException
     */
    public function testPublishPostsWithCustomSiteViewsToFilesystemWithPagination()
    {
        // Setup
        $site = 'site1.exampletld';
